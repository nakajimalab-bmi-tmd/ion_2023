...
if __name__ == '__main__':
    ...
    cls_name = "FS.if30recursive"
    maxID_prg = irispy.classMethodValue(cls_name, "getmaxID")

    q = {"Role" : "uuu", "Entity" : "PID001", "BaseEntity" : "any", "Temporal" : "any", "Spatical" : "any", "Property" : json.dumps({"format": "inaoka_program_sample_semantic"})}

    sum_time, i = get_prgID_time(cls=cls_name, R=q["Role"], E=q["Entity"], BE=q["BaseEntity"], T=q["Temporal"], S=q["Spatical"], P=q["Property"], start=31, end=(maxID_prg+1))
    time_dic = {str(i): sum_time}
    ls_prg = get_program_ID(cls=cls_name, R=q["Role"], E=q["Entity"], BE=q["BaseEntity"], T=q["Temporal"], S=q["Spatical"], P=q["Property"], start=31, end=(maxID_prg+1))
