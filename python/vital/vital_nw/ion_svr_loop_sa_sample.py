...
#main
#server側のクエリ（担当のクエリ）
svr_q_dic = {"semantics" : {"entity": "PID", "baseentity" : "any", "role" : "saturation", "spatial" : "any", "temporal" : "any"}, "dataproperty": {"format": "inaoka_program_sample"}}
...
while True:
    ...
    while True:
        ...
        for i in range(len(ls_de)):
            ls_de_use = get_IRISobj_dic(cls="ion.bital", R="機器ID", E=cli_dic["semantics"]["entity"],BE=None, DB=ls_de[i][3],T=None, S=None, start=1, end=(maxID+1))
